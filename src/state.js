...
S.prefs = {view:"grid",sort:"num",sortDir:"desc",showRecent:false};
...
S.smbMap = undefined;
S.SMB_SOURCES_KEY = 'mdb_smb_sources';
S.smbSources = [];
S.ANDROID_PLAYER_KEY = 'mdb_android_player';
S.androidPlayer = localStorage.getItem(S.ANDROID_PLAYER_KEY) || 'vlc';
